  ...
  return (
    <div className={`flex flex-col gap-1 ${className ?? ''}`}>
      ...
      <input
        ...
        className={`w-full rounded-lg border-2 px-4 py-2.5 text-sm text-input outline-none transition-colors placeholder:text-muted focus:border-primary focus:ring-2 focus:ring-primary/20 focus:animate-input-focus ${
          hasError
