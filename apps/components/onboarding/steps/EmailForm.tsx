...
const EmailForm = () => {
  ...
  return (
    <div className="text-center space-y-8 pt-5 pb-6">
      <p className="text-primary pt-13 font-fira font-bold text-5xl leading-10">
      ...
      />
      <p className="pt-6.5 font-lato font-bold text-[20px] leading-6">
      ...
      <div className="mt-8 flex justify-center w-full max-w-lg mx-auto">
        <Button variant="secondary" rounded type="submit" className="w-full">
          GET MY GUIDE
        </Button>
      </div>
    </div>
